    ...
    <footer className="border-t border-[#1a2236] mt-32 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 py-14 flex flex-col md:flex-row items-start justify-between gap-10 relative z-10">
        ...
        <div className="max-w-[240px]">
          ...
          <p className="text-[14px] text-[#8b98b4] leading-relaxed">
        ...
        <div className="flex gap-14 text-[14px]">
          <div className="flex flex-col gap-3">
            <div className="text-[12px] font-semibold text-[#7c8aa5] uppercase tracking-[0.12em] mb-1">Product</div>
            {[['Features', '#features'], ['Pricing', '#pricing'], ['Sign in', '/login']].map(([label, href]) => (
              <Link key={label} href={href} className="text-[#8b98b4] hover:text-[#8b98b4] transition-colors duration-200">{label}</Link>
            ))}
          </div>
          <div className="flex flex-col gap-3">
            <div className="text-[12px] font-semibold text-[#7c8aa5] uppercase tracking-[0.12em] mb-1">Legal</div>
      ...
      <div className="max-w-6xl mx-auto px-6 pb-8 flex items-center justify-between relative z-10">
        <p className="text-[12px] text-[#7c8aa5]">© 2026 Sangam.ai. Built with AI, for builders.</p>
        <div className="flex items-center gap-2 text-[12px] text-[#7c8aa5]">
